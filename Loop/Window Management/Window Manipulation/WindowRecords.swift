...
enum WindowRecords {
    ...
    static func record(_ window: Window, _ action: WindowAction) {
        ...
        if storeAsFrame, let screen = ScreenUtility.screenContaining(window) {
            ...
            let windowFrameInScreen = CGRect(
            ...
            let action = WindowAction(
                ...
                unit: .pixels,
                anchor: nil,
                width: windowFrameInScreen.width,
                height: windowFrameInScreen.height,
                xPoint: windowFrameInScreen.minX,
                yPoint: windowFrameInScreen.minY,
